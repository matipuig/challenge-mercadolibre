/**
 * Contains the mock for the MELI category.
 */
import { MELIRawCategory } from '../../../../src/types/services/MercadoLibre/Item';

export const mockedMELCategory: MELIRawCategory = {
  id: 'MLA1073',
  name: 'Perros de Raza',
  picture: null,
  permalink: null,
  total_items_in_this_category: 105289,
  path_from_root: [
    {
      id: 'MLA1071',
  ...
  settings: {
    ...
    catalog_domain: 'MLA-PUREBRED_DOGS',
